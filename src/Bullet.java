...
public class Bullet extends GameEntity
{
    ...
    public Bullet(int damage, int speed, int type, int x, int y, double bulletDirection)
    {
        this.damage = damage;
        this.speed = speed;
        this.type = type;
    ...
    public Bullet drawBullet(int damage, int speed, int type, int x, int y, double bulletDirection)
    {
